      ...
      <main className="w-full max-w-6xl flex flex-col px-6 md:px-12 pt-40 pb-60">
        ...
        <section id="identity" className="flex flex-col gap-12 mb-[40vh]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="dynamic-card p-8 rounded-3xl">
              <span className="text-magenta-500 font-mono text-[10px] font-bold uppercase">Nov 2021 — Oct 2023 [cite: 22]</span>
              <h3 className={`${textPrimary} text-xl font-bold mt-2`}>NTT Data [cite: 19]</h3>
              <p className={`${textSecondary} text-sm mt-4 leading-relaxed`}>
                Engineered an ML-driven Fraud Detection POC, translating insurance claim workflows into technical data models[cite: 25, 26].
              </p>
            </div>
            <div className="dynamic-card p-8 rounded-3xl">
              <span className="text-zinc-500 font-mono text-[10px] font-bold uppercase">Aug 2018 — May 2021 [cite: 32]</span>
              <h3 className={`${textPrimary} text-xl font-bold mt-2`}>Crestech Systems [cite: 29]</h3>
              <p className={`${textSecondary} text-sm mt-4 leading-relaxed`}>
                Directed end-to-end QA and API testing for **Max Life Insurance** web and mobile platforms[cite: 33].
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <div className="group relative">
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-72 h-40 bg-black/90 rounded-xl border border-violet-500/40 opacity-0 group-hover:opacity-100 transition-all pointer-events-none flex items-center justify-center text-[10px] text-zinc-400 p-4 leading-relaxed">
                Evaluating open-weight models for high-security, offline documentation workflows without cloud data leakage[cite: 37, 38].
              </div>
            </div>
            <div className="group relative">
              <span className="px-5 py-2 rounded-full bg-magenta-500/10 border border-magenta-500/20 text-magenta-500 text-xs font-bold uppercase cursor-help transition-all hover:bg-magenta-500/20">n8n Automation [cite: 40]</span>
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-72 h-40 bg-black/90 rounded-xl border-magenta-500/40 opacity-0 group-hover:opacity-100 transition-all pointer-events-none flex items-center justify-center text-[10px] text-zinc-400 p-4 leading-relaxed">
                Ingesting API payloads and parsing JSON to replace manual SQL reconciliation, reducing Time-to-Insight by 50%[cite: 42, 43].
              </div>
            </div>
          </div>
