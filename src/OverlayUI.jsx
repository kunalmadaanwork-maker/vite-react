// File 3: OverlayUI.jsx (Anonymized & Syntax-Fixed)
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <main className="w-full max-w-6xl flex flex-col px-6 md:px-12 pt-40 pb-60">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="dynamic-card p-8 rounded-3xl">
              ...
              <p className={`${textSecondary} text-sm mt-4 leading-relaxed`}>
                Leading high-stakes transformation for **Tier-1 North American Banks** and **Global Retailers**, specializing in AI pipelines and deep-dive data audits.
              </p>
            </div>
            <div className="dynamic-card p-8 rounded-3xl">
              ...
              <p className={`${textSecondary} text-sm mt-4 leading-relaxed`}>
                Engineered an ML-driven Fraud Detection POC, translating complex insurance workflows into predictive data models recognized for production readiness.
              </p>
            </div>
            <div className="dynamic-card p-8 rounded-3xl">
        ...
        {/* SECTION 2: AI JOURNEY (RAG FLOW INTEGRATED) */}
        <section id="aijourney" className="flex flex-col gap-[30vh] mb-[40vh]">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1">
                ...
                <p className={`${textSecondary} text-lg leading-relaxed mb-8`}>
                  Engineered a hallucination-free documentation pipeline for a **Tier-1 Bank**. Leveraged Enterprise Copilot to extract intent, feeding a secure Knowledge Base fortified with strict guardrails.
                </p>
                <div className="flex gap-10">
                  ...
                  <div>
                    ...
                    <div className={`${textSecondary} text-xs uppercase font-bold`}>Time Saved</div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 w-full grid grid-cols-3 items-center gap-2">
                <div className="flex flex-col items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 text-center">
                  ...
                  <span className="text-[8px] text-zinc-500">Intent Extraction</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 p-4 rounded-xl bg-violet-500/10 border border-violet-500/20 text-center">
                  ...
                  <span className="text-[10px] text-white font-bold">Knowledge Base</span>
                  <span className="text-[8px] text-violet-400">Sync & Guardrails</span>
                </div>
                ...
                <div className="col-start-3 flex flex-col items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 text-center">
                  ...
                  <span className="text-[8px] text-teal-500">Zero Hallucination</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="node-right self-end w-full md:w-[48%] dynamic-card p-10 rounded-3xl md:text-right group relative overflow-hidden reveal">
            <div className="group-hover:opacity-0 transition-opacity duration-300">
              ...
              <p className={`${textSecondary} leading-relaxed`}>Automated manual fraud detection by mapping high-risk indicators to predictive model architectures for global insurance clients.</p>
            </div>
            ...
            <div className="absolute inset-0 bg-magenta-900/95 backdrop-blur-xl p-8 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-center text-white text-left">
              ...
              <p className="text-xs leading-relaxed">Collaborated with Data Science teams to feature-engineer indicators for Python-based anomaly detection models.</p>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            ...
            <div className="group relative">
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-72 h-40 bg-black/90 rounded-xl border border-magenta-500/40 opacity-0 group-hover:opacity-100 transition-all pointer-events-none flex items-center justify-center text-[10px] text-zinc-300 p-4 leading-relaxed">
                Prototyping automated data-parsing pipelines to replace manual SQL reconciliation, reducing Time-to-Insight by 50%.
              </div>
            </div>
          </div>
