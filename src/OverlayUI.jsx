// File 3: OverlayUI.jsx (PIXEL-PERFECT POLISH)
...
export default function OverlayUI({ theme, setTheme }) {
  ...
  // BUG 3: Increased opacity and maximum blur to prevent BG overpowering
  const glassCard = isDark ? "rgba(10, 10, 10, 0.85)" : "rgba(255, 248, 231, 0.9)";
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <style>{`
        ...
        /* BUG 3: Heavy backdrop blur and solid-ish background for readability */
        .dynamic-card { background: ${glassCard}; backdrop-filter: blur(40px); border: 1px solid ${borderLight}; transition: all 0.7s ease; }
        ...
        <section id="identity" className="flex flex-col gap-12 mb-[40vh]">
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <p className={`${textSecondary} text-lg max-w-2xl leading-relaxed`}>
              7+ years of experience bridging enterprise architecture and Agile delivery[cite: 4, 9]. Certified Scrum Master (CSM®) and Product Owner (CSPO®)[cite: 44].
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="dynamic-card p-8 rounded-3xl">
              {/* BUG 1: Synchronized Date Colors */}
              ...
              <p className={`${textSecondary} text-sm mt-4 leading-relaxed`}>
                Driving transformation for **Tier-1 Financial Leaders** and **Global Retailers**, specializing in AI pipelines and deep-dive data audits[cite: 6, 11, 13, 15, 17].
              </p>
            </div>
            <div className="dynamic-card p-8 rounded-3xl">
              {/* BUG 1: Synchronized Date Colors */}
              ...
              <p className={`${textSecondary} text-sm mt-4 leading-relaxed`}>
                Engineered an ML-driven Fraud Detection POC, translating complex insurance workflows into predictive data models[cite: 22, 24, 25, 26].
              </p>
            </div>
            <div className="dynamic-card p-8 rounded-3xl">
              {/* BUG 1: Synchronized Date Colors */}
              ...
              <p className={`${textSecondary} text-sm mt-4 leading-relaxed`}>
                Directed end-to-end QA for **Major Insurance product streams**, ensuring 100% data integrity across mobile and web platforms[cite: 32, 33, 34].
              </p>
            </div>
          </div>
        </section>

        {/* SECTION 2: AI JOURNEY (BUG 2: COMPACT RAG FLOW) */}
        <section id="aijourney" className="flex flex-col gap-[20vh] mb-[40vh]">
          ...
          <div className="w-full dynamic-card p-10 md:p-14 rounded-[3rem] reveal border-violet-500/10">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-1">
                ...
                {/* BUG 2: Reduced text bulk */}
                <p className={`${textSecondary} text-base leading-relaxed mb-6`}>
                  Engineered a hallucination-free pipeline for a **Tier-1 Bank**. Leveraged Enterprise Copilot to feed a secure Knowledge Base fortified with strict guardrails[cite: 6, 15].
                </p>
              ...
              {/* BUG 2: Compact Design with Larger Node Fonts */}
              <div className="flex-1 w-full flex items-center justify-center gap-2">
                <div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-white/5 border border-white/5 text-center min-w-[100px]">
                ...
                <div className="h-px w-6 bg-teal-500/40" />
                <div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-violet-500/10 border border-violet-500/20 text-center min-w-[120px]">
          ...
          <div className="node-right self-end w-full md:w-[48%] dynamic-card p-10 rounded-3xl md:text-right group relative overflow-hidden reveal">
            <div className="group-hover:opacity-0 transition-opacity duration-300">
              ...
              <p className={`${textSecondary} leading-relaxed`}>Automated manual fraud detection by mapping high-risk indicators to predictive model architectures for global insurance clients[cite: 25, 28].</p>
            </div>
            ...
            <div className="absolute inset-0 bg-magenta-900/95 backdrop-blur-3xl p-8 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-center text-white text-left">
              ...
              <p className="text-xs leading-relaxed">Collaborated with Data Science teams to feature-engineer indicators for anomaly detection models[cite: 24, 26, 27].</p>
            </div>
          </div>
        </section>
        ...
        <section id="horizon" className={`reveal dynamic-card p-12 rounded-3xl text-center mb-[40vh] border-dashed ${isDark ? 'border-violet-500/20' : 'border-violet-500/40'}`}>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <div className="group relative">
              <span className="px-5 py-2 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-500 text-xs font-bold uppercase cursor-help transition-all hover:bg-violet-500/20">Local LLM Testing</span>
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-72 h-40 bg-black/90 rounded-xl border border-violet-500/40 opacity-0 group-hover:opacity-100 transition-all pointer-events-none flex items-center justify-center text-[10px] text-zinc-300 p-4 leading-relaxed">
                Evaluating open-weight models for secure, offline documentation workflows without cloud data leakage[cite: 37, 39].
              </div>
            </div>
            <div className="group relative">
              {/* BUG 1: n8n Color Fix */}
              <span className="px-5 py-2 rounded-full bg-magenta-500/20 border border-magenta-500/40 text-magenta-600 dark:text-magenta-400 text-xs font-bold uppercase cursor-help transition-all hover:bg-magenta-500/30">n8n Automation</span>
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-72 h-40 bg-black/90 rounded-xl border border-magenta-500/40 opacity-0 group-hover:opacity-100 transition-all pointer-events-none flex items-center justify-center text-[10px] text-zinc-300 p-4 leading-relaxed">
                Prototyping automated data-parsing pipelines to replace manual SQL reconciliation tasks[cite: 40, 41, 43].
              </div>
            </div>
          </div>
